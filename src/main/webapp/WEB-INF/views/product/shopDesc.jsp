        ...
        <div id="container">
            ...
            <main>
                <div id="mainWrap">
                    <div id="shopTop">
                        <div id="shopTopImg" class="shopTopBox">
                            <div class="product-details">
                                <img class="product-image" src="${product.pImagePath }" alt="상품 이미지">
                            </div>
                        </div>
                        <div id="shopTopInfo" class="shopTopBox">
                            <div id="infoTitle">
                                <p class="product-name">${product.productName }</p>
                                <input type="hidden" id=productImg value="${product.pImagePath }">
                                <input type="hidden" id="productNo" value="${product.productNo }">
                                <input type="hidden" class="product-price" value="${product.productPrice }">
                            ...
                            <div id="infoSelect" style="display:none">
                                <span id="pName" class="product-name">${product.productName }</span>
                    ...
                    <div id="shopMid">
                        <img class="product-image-desc" src="${product.pImagePath }" alt="상품 이미지">
                        <img class="product-image-desc2" src="${product.pImagePath }" alt="상품 이미지">
                    </div>
                    <div id="shopBtm">
